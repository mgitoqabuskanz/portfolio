  ...
  return (
    <div id="about" className='flex items-center justify-center'>
      <div className="p-10 max-w-7xl text-center mx-10 md:mx-25 space-y-3">
        ...
        <h2 className='text-2xl'>Full-Stack Developer | Network Operations Center (NOC) Engineer | Cybersecurity Specialist</h2>
        <p className="text-justify text-indent mt-10">
        ...
        <div className="flex items-start justify-center pt-10">
          <div className="flex-1 flex flex-col space-y-3 pr-4 text-end"> {/* Added text-end here */}
